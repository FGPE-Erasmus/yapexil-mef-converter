...
describe('YAPExIL to MEF conversion.', () => {
  ...
  afterAll(() => {
    ...
    Object.keys(executionTimes).forEach(type => console.log(executionTimes[type].join('\n')));
  });
  ...
  test('should convert BLANK_SHEET A', async () => {
    ...
    expect(obtainedZip.numberOfRecordsOnDisk).toBe(expectedZip.numberOfRecordsOnDisk);
    expect(obtainedZip.sizeOfCentralDirectory).toBe(expectedZip.sizeOfCentralDirectory);
  });
